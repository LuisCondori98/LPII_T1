...
public class RegistroCondori extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RegistroCondori frame = new RegistroCondori();
	...
	public RegistroCondori() {
		...
		JLabel lblCodigo = new JLabel("Id. Usuario :");
		...
		JLabel lblNomProducto = new JLabel("Correo Usuario:");
